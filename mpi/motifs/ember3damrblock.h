...
namespace SST {
    namespace Ember {
        ...
        public:
            ...
            void setCommXUp(const int32_t x1, const int32_t x2, const int32_t x3,
                            const int32_t x4) {
                commXUp[0] = x1;
                commXUp[1] = x2;
                commXUp[2] = x3;
            ...
            void setCommXDown(const int32_t x1, const int32_t x2, const int32_t x3,
                              const int32_t x4) {
                commXDown[0] = x1;
                commXDown[1] = x2;
                commXDown[2] = x3;
            ...
            void setCommYUp(const int32_t x1, const int32_t x2, const int32_t x3,
                            const int32_t x4) {
                commYUp[0] = x1;
                commYUp[1] = x2;
                commYUp[2] = x3;
            ...
            void setCommYDown(const int32_t x1, const int32_t x2, const int32_t x3,
                              const int32_t x4) {
                commYDown[0] = x1;
                commYDown[1] = x2;
                commYDown[2] = x3;
            ...
            void setCommZUp(const int32_t x1, const int32_t x2, const int32_t x3,
                            const int32_t x4) {
                commZUp[0] = x1;
                commZUp[1] = x2;
                commZUp[2] = x3;
            ...
            void setCommZDown(const int32_t x1, const int32_t x2, const int32_t x3,
                              const int32_t x4) {
                commZDown[0] = x1;
                commZDown[1] = x2;
                commZDown[2] = x3;
            ...
            void printFile(FILE *f) {
                ...
                PRIu32
                "\n", blockID, refinementLevel);
                fprintf(f, "- Refine X up:   Refinement: %7"
                PRId32
                ", Comm={ %7"
                PRId32
                ",%7"
                ...
                "}\n",
                    refine_x_up, commXUp[0], commXUp[1], commXUp[2], commXUp[3]);
                fprintf(f, "- Refine X down: Refinement: %7"
                PRId32
                ", Comm={ %7"
                PRId32
                ",%7"
                ...
                "}\n",
                    refine_x_down, commXDown[0], commXDown[1], commXDown[2], commXDown[3]);
                fprintf(f, "- Refine Y up:   Refinement: %7"
                PRId32
                ", Comm={ %7"
                PRId32
                ",%7"
                ...
                "}\n",
                    refine_y_up, commYUp[0], commYUp[1], commYUp[2], commYUp[3]);
                fprintf(f, "- Refine Y down: Refinement: %7"
                PRId32
                ", Comm={ %7"
                PRId32
                ",%7"
                ...
                "}\n",
                    refine_y_down, commYDown[0], commYDown[1], commYDown[2], commYDown[3]);
                fprintf(f, "- Refine Z up:   Refinement: %7"
                PRId32
                ", Comm={ %7"
                PRId32
                ",%7"
                ...
                "}\n",
                    refine_z_up, commZUp[0], commZUp[1], commZUp[2], commZUp[3]);
                fprintf(f, "- Refine Z down: Refinement: %7"
                PRId32
                ", Comm={ %7"
                PRId32
                ",%7"
