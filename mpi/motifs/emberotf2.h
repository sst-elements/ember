    ...
    namespace Ember {
        ...
        public:
            ...
            void setCurrentTime(const OTF2_TimeStamp t) {
                verbose(CALL_INFO, 4, 0, "Setting current timestamp to %"
                PRIu64
                "\n", t );
            ...
            void printRequestMap() {
                verbose(CALL_INFO, 4, 0, "Request Map on Rank: %"
                PRIu32
                " contains: %"
                PRIu64
                " entries.\n",
                ...
                for (auto reqItr = requestMap.begin(); reqItr != requestMap.end(); reqItr++) {
                    verbose(CALL_INFO, 4, 0, "Request: %20"
                    PRIu64
                    "\n", reqItr->first );
                }
            }
            ...
            PayloadDataType extractDataTypeFromAttributeList(OTF2_AttributeList *attr) {
                ...
                verbose(CALL_INFO, 16, 0, "Attribute list on rank: %"
                PRIu32
                " contains %"
                PRIu32
                " attributes\n",
