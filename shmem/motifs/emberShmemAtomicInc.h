...
namespace SST {
    namespace Ember {
        ...
        class EmberShmemAtomicIncBaseGenerator : public EmberShmemGenerator {
            ...
            std::string m_opStr;
        public:
            EmberShmemAtomicIncBaseGenerator(SST::Component *owner, Params &params,
                                             std::string name) :
        ...
        template<class TYPE>
        class EmberShmemAtomicIncGenerator<TYPE, 1>
            : public EmberShmemAtomicIncBaseGenerator<TYPE, 1> {
        public:
            EmberShmemAtomicIncGenerator(SST::Component *owner, Params &params, std::string name) :
        ...
        template<class TYPE>
        class EmberShmemAtomicIncGenerator<TYPE, 2>
            : public EmberShmemAtomicIncBaseGenerator<TYPE, 2> {
        public:
            EmberShmemAtomicIncGenerator(SST::Component *owner, Params &params, std::string name) :
