...
namespace SST {
    namespace Ember {
        ...
        class EmberShmemAtomicIncV2BaseGenerator : public EmberShmemGenerator {
            ...
            std::string m_opStr;
        public:
            EmberShmemAtomicIncV2BaseGenerator(SST::Component *owner, Params &params,
                                               std::string name) :
                EmberShmemGenerator(owner, params, name), m_phase(Init1), m_one(1), m_curUpdate(0),
                m_loopCnt(0), m_detailedDone(false) {
                    ...
                    case FiniLoop:
                        ...
                        if (0 == m_my_pe) {
                            printf("outerLoop done loopCnt=%d %f\n", m_loopCnt,
                                   ((double) m_updates * (double) m_num_pes * 1.0e-9) /
                                   m_times[m_loopCnt]);
                        }
        ...
        protected:
            ...
            TYPE m_result;
            enum {
                Init1, Init2, InitLoop, Work, FiniLoop, Fini
            } m_phase;
            int m_my_pe;
            int m_num_pes;
            int m_node_num;
        ...
        template<class TYPE, int VAL>
        class EmberShmemAtomicIncV2Generator
            : public EmberShmemAtomicIncV2BaseGenerator<TYPE, VAL> {
        public:
            EmberShmemAtomicIncV2Generator(SST::Component *owner, Params &params, std::string name)
                :
                EmberShmemAtomicIncV2BaseGenerator<TYPE, VAL>(owner, params, name) {
            }
        };

        template<class TYPE>
        class EmberShmemAtomicIncV2Generator<TYPE, 1>
            : public EmberShmemAtomicIncV2BaseGenerator<TYPE, 1> {
        public:
            EmberShmemAtomicIncV2Generator(SST::Component *owner, Params &params, std::string name)
                :
                EmberShmemAtomicIncV2BaseGenerator<TYPE, 1>(owner, params, name) {
            }
        ...
        template<class TYPE>
        class EmberShmemAtomicIncV2Generator<TYPE, 2>
            : public EmberShmemAtomicIncV2BaseGenerator<TYPE, 2> {
        public:
            EmberShmemAtomicIncV2Generator(SST::Component *owner, Params &params, std::string name)
                :
                EmberShmemAtomicIncV2BaseGenerator<TYPE, 2>(owner, params, name) {
            }
        ...
        public:
            EmberShmemAtomicIncV2IntGenerator(SST::Component *owner, Params &params) :
                EmberShmemAtomicIncV2Generator(owner, params, "ShmemAtomicIncV2Int") {}
        };
        ...
        public:
            EmberShmemNSAtomicIncV2IntGenerator(SST::Component *owner, Params &params) :
                EmberShmemAtomicIncV2Generator(owner, params, "ShmemNSAtomicIncV2Int") {}
        };
        ...
        public:
            EmberShmemHotAtomicIncV2IntGenerator(SST::Component *owner, Params &params) :
                EmberShmemAtomicIncV2Generator(owner, params, "ShmemHotAtomicIncV2Int") {}
        };
        ...
        public:
            EmberShmemAtomicIncV2LongGenerator(SST::Component *owner, Params &params) :
                EmberShmemAtomicIncV2Generator(owner, params, "ShmemAtomicIncV2Long") {}
        };

        class EmberShmemHotAtomicIncV2LongGenerator
            : public EmberShmemAtomicIncV2Generator<long, 1> {
        public:
            SST_ELI_REGISTER_SUBCOMPONENT(
        ...
        public:
            EmberShmemHotAtomicIncV2LongGenerator(SST::Component *owner, Params &params) :
                EmberShmemAtomicIncV2Generator(owner, params, "ShmemHotAtomicIncV2Long") {}
        };
