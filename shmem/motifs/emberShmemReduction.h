...
namespace SST {
    namespace Ember {
                    ...
                    case 1:
                        if (0 == m_my_pe) {
                            printf("%d:%s: num_pes=%d nelems=%d type=\"%s\"\n", m_my_pe,
                                   getMotifName().c_str(), m_num_pes, m_nelems,
                                   m_type_name.c_str());
                        }
                        {
                    ...
                    case 3:
                        switch (m_op) {
                            case AND:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_and_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                           m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_and_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                            m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
                            ...
                            case OR:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_or_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                          m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_or_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                           m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
                            ...
                            case XOR:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_xor_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                           m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_xor_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                            m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
                            ...
                            case SUM:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_sum_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                           m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_sum_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                            m_num_pes, m_pSync);
                                        break;
                                    case Float:
                                        enQ_float_sum_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                             m_num_pes, m_pSync);
                                        break;
                                    case Double:
                                        enQ_double_sum_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                              m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
                            ...
                            case PROD:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_prod_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                            m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_prod_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                             m_num_pes, m_pSync);
                                        break;
                                    case LongLong:
                                        enQ_longlong_prod_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                                 m_num_pes, m_pSync);
                                        break;
                                    case Float:
                                        enQ_float_prod_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                              m_num_pes, m_pSync);
                                        break;
                                    case Double:
                                        enQ_double_prod_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                               m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
                            ...
                            case MIN:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_min_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                           m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_min_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                            m_num_pes, m_pSync);
                                        break;
                                    case Float:
                                        enQ_float_min_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                             m_num_pes, m_pSync);
                                        break;
                                    case Double:
                                        enQ_double_min_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                              m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
                            ...
                            case MAX:
                                switch (m_type) {
                                    case Int:
                                        enQ_int_max_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                           m_num_pes, m_pSync);
                                        break;
                                    case Long:
                                        enQ_long_max_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                            m_num_pes, m_pSync);
                                        break;
                                    case Float:
                                        enQ_float_max_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                             m_num_pes, m_pSync);
                                        break;
                                    case Double:
                                        enQ_double_max_to_all(evQ, m_dest, m_src, m_nelems, 0, 0,
                                                              m_num_pes, m_pSync);
                                        break;
                                    default:
                                        assert(0);
        ...
        class EmberShmemReductionLongLongGenerator
            : public EmberShmemReductionGenerator<long long> {
        public:
            SST_ELI_REGISTER_SUBCOMPONENT(
