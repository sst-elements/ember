                ...
                switch (m_phase) {
                    ...
                    case 1:
                        ...
                        }
                        {
                            ...
                            buffer_size +=
                                m_nelems * sizeof(TYPE) * m_num_pes * m_sst;  // for source
                    ...
                    case 2:
                        ...
                        for (int pe = 0; pe < m_num_pes; pe++) {
                            ...
                            for (int i = 0; i < m_nelems; i++) {
                                ...
                                m_src.at<TYPE>(pe * m_nelems * m_sst + i * m_sst) =
                    ...
                    case 3:
                        if (4 == sizeof(TYPE)) {
                            enQ_alltoalls32(evQ, m_dest, m_src, m_dst, m_sst, m_nelems, 0, 0,
                                            m_num_pes, m_pSync);
                        } else {
                            enQ_alltoalls64(evQ, m_dest, m_src, m_dst, m_sst, m_nelems, 0, 0,
                                            m_num_pes, m_pSync);
                        }
                        break;
                        ...
                        for (int pe = 0; pe < m_num_pes; pe++) {
                            ...
                            for (int i = 0; i < m_nelems; i++) {
                                ...
                                if (m_printResults) {
                                    ...
                                    PRIx64
                                    "\n", m_my_pe, getMotifName().c_str(),
                                        (uint64_t) m_dest.getSimVAddr<TYPE>(
                                            pe * m_nelems * m_dst + i * m_dst),
                                        pe, i, (uint64_t) m_dest.at<TYPE>(
                                        pe * m_nelems * m_dst + i * m_dst));
                                }

                                assert(m_dest.at<TYPE>(pe * m_nelems * m_dst + i * m_dst) ==
                                       (((TYPE) (pe + 1) << shift) | i + 1));
                            }
                        }
                        if (0 == m_my_pe) {
