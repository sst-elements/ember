...
namespace SST {
    namespace Ember {
        ...
        public:
            EmberShmemFAM_CswapBaseGenerator(SST::Component *owner, Params &params,
                                             std::string name) :
                EmberShmemGenerator(owner, params, name), m_phase(-3), m_numFamNodes(0),
                m_oldValue(0), m_newValue(1) {
        ...
        template<class TYPE>
        class EmberShmemFAM_CswapGenerator<TYPE, 1>
            : public EmberShmemFAM_CswapBaseGenerator<TYPE, 1> {
        public:
            EmberShmemFAM_CswapGenerator(SST::Component *owner, Params &params, std::string name) :
        ...
        template<class TYPE>
        class EmberShmemFAM_CswapGenerator<TYPE, 2>
            : public EmberShmemFAM_CswapBaseGenerator<TYPE, 2> {
        public:
            EmberShmemFAM_CswapGenerator(SST::Component *owner, Params &params, std::string name) :
