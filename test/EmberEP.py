...
class EmberEP(EndPoint):
    def __init__(self, jobId, driverParams, nicParams, motifs, numCores, ranksPerNode, statNodes, nidMap, numNodes,
                 motifLogNodes, detailedModel):  # added motifLogNodes here
