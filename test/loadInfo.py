...
class LoadInfo:
    ...
    def __init__(self, numNics, baseNicParams, defaultEmberParams):
        ...
        nullMotif = {'motif0.api': '', 'motif0.name': 'ember.NullMotif', 'motif0.printStats': 0,
    ...
    def createEP(self, jobId, nidList, ranksPerNode, motifs, statNodes, detailedModel=None):
        ...
        ep = EmberEP(jobId, epParams, nicParams, motifs, numCores, ranksPerNode, statNodes, self.globalToLocalNidMap,
                     numNodes, motifLogNodes, detailedModel)  # added motifLogNodes here
    ...
    def initWork(self, nidList, workList, statNodes):
        ...
        jobid = workList[0][0]
        work = workList[0][1]
        ep = self.createEP(jobid, nidList, self.parts[nidList].numCores, self.readWorkList(jobid, nidList, work),
                           statNodes, self.parts[nidList].detailedModel)
