        ...
        for x in CrossProduct(network['args']):
            for y in CrossProduct(test['args']):
                hash_object = hashlib.md5(
                    b"sst --model-options=\"--topo={0} {1} --cmdLine=\\\"Init\\\" --cmdLine=\\\"{2} {3}\\\" --cmdLine=\\\"Fini\\\"\" {4}".format(
                        network['topo'], x, test['motif'], y, config))
                ...
                print "sst --model-options=\"--topo={0} {1} --cmdLine=\\\"Init\\\" --cmdLine=\\\"{2} {3}\\\" --cmdLine=\\\"Fini\\\"\" {4} > tmp_file".format(
                    network['topo'], x, test['motif'], y, config)
